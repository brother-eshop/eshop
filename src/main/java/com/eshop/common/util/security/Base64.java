...
public class Base64 {
	 ...
	 * @param isChunked
	 *            if isChunked is true this encoder will chunk the base64 output into 76 character blocks
	...
	/**
	 * Discards any characters outside of the base64 alphabet, per the requirements on page 25 of RFC 2045 - "Any characters outside of the base64 alphabet are
